...
Plant.create!(name: "Basilic", temperature_max: 32, temperature_min: 0, associations: ["Tomate"], harvest_day_after_planting: 120, length: 5, width: 5, sunshine: 2, image: 'Basilic')
...
Plant.create!(name: "Navet", temperature_max: 32, temperature_min: 0, associations: ["Laitue"], harvest_day_after_planting: 164, length: 5, width: 5, sunshine: 2, image: 'Navet')
